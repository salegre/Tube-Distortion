...
//==============================================================================
const String TubeDistortionAudioProcessor::getName() const
{
...
const String TubeDistortionAudioProcessor::getProgramName (int index)
{
    return {};
}

void TubeDistortionAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
void TubeDistortionAudioProcessor::processBlock (AudioSampleBuffer& buffer, MidiBuffer& midiMessages)
{
...
AudioProcessorEditor* TubeDistortionAudioProcessor::createEditor()
{
    return new TubeDistortionAudioProcessorEditor (*this);
}

//==============================================================================
void TubeDistortionAudioProcessor::getStateInformation (MemoryBlock& destData)
{
